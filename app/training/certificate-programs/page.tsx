...
import { Award, Users, Star, TrendingUp, CheckCircle, BarChart3, Monitor, BookOpen, GraduationCap, ExternalLink } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

const navigationItems = [
  { title: "Certificate Programs", href: "/training/certificate-programs", icon: "Award", current: true },
      ...
      <section className="py-8 bg-muted/30 border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-4">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Certificate Programs</span>
          </div>
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Advance your HR career with globally recognized certifications. Our collaboration with AIHR brings you
                cutting-edge training programs designed by industry experts.
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Ready to Start Your HR Certification Journey?
              </h3>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                Enroll in AIHR's comprehensive HR certification programs and advance your career today.
              </p>
