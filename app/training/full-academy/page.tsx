...
const navigationItems = [
  ...
  { title: "Full Academy", href: "/training/full-academy", icon: "GraduationCap", current: true },
]
      ...
      <section className="py-8 bg-muted/30 border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-4">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Full Academy</span>
          </div>
            ...
            >
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <div className="text-left">
                  <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-2">Full Academy</h1>
                  <p className="text-accent font-semibold">In collaboration with AIHR</p>
                </div>
              </div>

              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Get unlimited access to AIHR's complete academy through our collaboration. From foundational
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
                ...
                <div className="flex items-center space-x-2 bg-white/50 rounded-full px-4 py-2">
                  ...
                  <span className="font-semibold">500+ Hours Content</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Ready to Access the Full AIHR Academy?
              </h3>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                Get unlimited access to AIHR's complete academy and transform your HR career with comprehensive learning.
              </p>
              ...
              {[
                {
                  ...
                  description: "Get unlimited access to all AIHR courses and content",
                },
                {
                  icon: Award,
