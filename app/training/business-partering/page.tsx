...
import { Users, Award, Star, TrendingUp, CheckCircle, BarChart3, Monitor, BookOpen, GraduationCap, ExternalLink } from "lucide-react"
...
const navigationItems = [
  ...
  { title: "Business Partnering", href: "/training/business-partering", icon: "Users", current: true },
      ...
      <section className="py-8 bg-muted/30 border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-4">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Business Partnering</span>
          </div>
            ...
            >
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <div className="text-left">
                  <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-2">Business Partnering</h1>
                  <p className="text-accent font-semibold">In collaboration with AIHR</p>
                </div>
              </div>

              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Become a strategic HR business partner who drives organizational success. Master stakeholder management,
                business acumen, and strategic alignment through our comprehensive program in collaboration with AIHR.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 mb-8">
                ...
                <div className="flex items-center space-x-2 bg-white/50 rounded-full px-4 py-2">
                  ...
                  <span className="font-semibold">2,500+ Graduates</span>
                </div>
                <div className="flex items-center space-x-2 bg-white/50 rounded-full px-4 py-2">
                  <TrendingUp className="w-5 h-5 text-accent" />
                  <span className="font-semibold">14 Weeks Program</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Ready to Become a Strategic HR Business Partner?
              </h3>
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                Enroll in AIHR's comprehensive Business Partnering program and transform your HR leadership skills today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild size="lg" variant="outline" className="border-accent text-accent hover:bg-accent hover:text-white">
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    View Business Partnering Program
                  </a>
                </Button>
              </div>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Master stakeholder management and business alignment",
                },
                {
                  icon: Award,
